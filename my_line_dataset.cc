...
class MyTextLineDatasetOp : public DatasetOpKernel {
 public:
 ...
 private:
  class Dataset : public GraphDatasetBase {
   public:
    ...
    string DebugString() override { return "MyTextLineDatasetOp::Dataset"; }
...
REGISTER_KERNEL_BUILDER(Name("MyTextLineDataset").Device(DEVICE_CPU),
                        MyTextLineDatasetOp);
